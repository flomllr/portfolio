...
import infiniteLogo from './assets/images/infinite.png';
...
const projects: ProjectProps[] = [
    {
        ...
        description: `With my good friends Justin Glibert and Jay Yeung, I'm working on a Software to automate customer support, starting with a voice assistant to handle calls when your support team is sleeping.`,
    ...
    },
    {
        ...
        description: `Dcode adds a simple but desired feature to Shopify stores - cart level discount code validation. I wrote the app in winter 2018 and currently manage one employee. More than 2,500 stores are actively using the app, including Kylie Jenner's <a href="https://www.kyliecosmetics.com/">kyliecosmetics.com</a>.`,
    ...
    },
    {
        ...
        description: `The Infinite Story is a text-based adventure game, whose story is generated by an AI. I built it with Justin Glibert in December 2019. Until today over 250,000 stories have been played by over 10,000 monthly active users.`,
        url: 'https://infinitestory.app',
        linktext: 'https://infinitestory.app',
        category: 'spotlight',
        image: infiniteLogo,
    },
    {
        ...
        description: `Context is a macOS app that radically simplifies window management for context changes. Berzan Mikaili and I built it at Hack.Zurich 2019, reached the final and won the 2nd prize in the productivity category.`,
    ...
    },
    {
        ...
        tags: ['Ionic'],
        description: `A mobile app that matches exchange students with local students and suggests social activities in line with their interests.`,
    ...
    },
    {
        ...
        description: `I designed and implemented the website you're looking at right now using React (TypeScript), my favorite frontend library.`,
        url: 'https://flomllr.com/',
        category: 'webdesign',
    },
    {
        title: 'Bube Concept',
